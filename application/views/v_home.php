        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="detail-box">
                    ...
                    <ul>
                        ...
                        <li>Tidak Menggunakan Foto</li>
                        <li>Unlimited Tamu Undangan</li>
                        <li>Custom Musik Background</li>
                        <li>Kartu Ucapan</li>
                        <li>Map Lokasi</li>
                        <li>Tidak Ada Love Story</li>
                        <li>Tidak Ada Galeri Foto</li>
                        <li>Bebas Revisi</li>
                    </ul>
                    </p>
                    <a href="">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="detail-box">
                    ...
                    <ul>
                        <li>Masa Aktif Selamanya</li>
                        <li>Diberikan Akun Khusus Member</li>
                        ...
                        <li>Map Lokasi</li>
                        <li>Love Story</li>
                        <li><b>Bisa Atur Semua Data Sendiri</b></li>
                    </ul>
                    </p>
                    <a href="">
                    Pesan Sekarang 
